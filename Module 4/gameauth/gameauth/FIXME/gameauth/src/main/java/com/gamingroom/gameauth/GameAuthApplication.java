...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// This step makes your controller accessible when the application runs, allowing it to handle incoming HTTP requests.
		e.jersey().register(new GameUserRESTController(e.getValidator()));
		// This client is used to make HTTP requests within your server, which can be useful for internal communications between services or for testing.
